...
.header-title {
    ...
    font-weight: bold; /* Hace el texto del título más destacado */
}
...
.overlay {
	background: #edc158;
	background: -webkit-linear-gradient(to right, #edc158, #b4846c);
	background: linear-gradient(to right, #edc158, #b4846c);
    ...
    <div class="overlay-container">
        <div class="overlay">
            <div class="overlay-panel overlay-left">
                <h1>Welcome Back!</h1>
                <p>To keep connected, please sign in with your personal information</p>
